...
void Mouse::update()
{
	...
	if (osCursorVisible || (!sensitivityAdjustmentNeeded && !mouse_raw_input.getBool()) || m_bAbsolute || env->getOS() == Environment::OS::OS_HORIZON || env->getOS() == Environment::OS::OS_VITA || env->getOS() == Environment::OS::OS_LINUX) // HACKHACK: linux hack
	{
